...
{
    public static MonsterFlash instance;
    ...
    private Vector3 startPosMonsterFlash;
    private Vector3 pointFlash;
    ...
    void Start()
    {
        ...
        anim.speed = 1.2f;
        nav.speed = 1.2f;
        startPosMonsterFlash = transform.position;
    }
    ...
    void Update()
    {
        ...
        if (alive)
        {
            ...
            if (state == "idle")
            {
                ...
                //pointFlash = navHit.position;
                nav.SetDestination(navHit.position);
                //if (transform.position == navHit.position)
                //{
                //    isFlash = true;
                //}
                //else
    ...
    void reset()
    {
        ...
        transform.position = startPosMonsterFlash;
        anim.speed = 1.2f;
        nav.speed = 1.2f;
        state = "idle";
    }
